    ...
    return (
        <div class="page-wrap">
            ...
            <aside class="page-sidebar">
                <div className='side' style={{background:'none', color:'#dcedc8'}}>
                <div className='icon'>
                    <MdAccountCircle style={{color:"#dcedc8"}}/>
                    <p>Account</p>
                </div>
                <div className='icon'>
                    <TiHome style={{color:"#dcedc8"}}/>
                    <p>Home</p>
                </div>
                <div className='icon'>

                    <MdLibraryMusic style={{color:"#dcedc8"}}/>
                    <p>Discover</p>
                </div>
                </div>
            </aside>
            ...
            <main class="page-main" >
                <div className='loot' style={{height:500}}> 
